...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                ...
                .antMatchers(HttpMethod.PUT, "/roleHierarchy").hasRole("USER")
                .antMatchers(HttpMethod.POST, "/roleHierarchy").hasRole("USER")
                .antMatchers(HttpMethod.DELETE, "/roleHierarchy").hasRole("ADMIN")
